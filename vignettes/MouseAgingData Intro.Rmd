...
the package can be accesssed by querying the ExperimentHub with the package name.
...
To view a simple workflow to analyze and visualize the downloaded data following the [OSCA Single-Cell Workbook](https://bioconductor.org/books/3.18/OSCA.basic/), do the following:
