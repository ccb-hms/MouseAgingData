...
detected in fewer than 3 cells were excluded. After initial QC, a total of 38,244 cells and 14,699 genes were retained.

The final round of QC filtering removed likely doublet artifacts arising from
...
specific for the initially identified cell type and also any other cell type it was associated with. These clusters were removed from downstream analysis.
Furthermore, cell clusters that were not represented by at least half of the
young and old animals were also excluded. For example, although epithelial cells (Epcam+/Krt18+) were detected in the dataset, they were detected only in two of the eight young animals but none of the old animals, and were therefore excluded in the dataset. After exclusions, clustering was again performed.
The final dataset includes the transcriptomes derived from the brains of
8 young (2–3 months) and 8 old (21–23 months) mice, and includes 37,089 cells representing 25 cell types and 14699 features. 


# Download processed data

The raw, unprocessed data for the 16 mice samples are available for download through GEO accession number [GSE129788](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE12978).

UMAP, TSNE, PCA coordinates and additional cell metadata were provided courtesy of the authors.
