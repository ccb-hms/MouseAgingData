#' Metadata for Filtered Dataset of Parabiosis Mouse Aging Project
#'
#' Filtered metadata for 10X Genomics parabiosis experiment
#' 20905 Genes in ENSEMBL format and 105329 cells
#'
#' @format ## A data frame with 12 columna and 105329 rows:
#' \describe{
...
#'
#'
#' @source <https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE222510>
#' @examples
#' data(parabiosis_metadata) # Lazy loading
"parabiosis_metadata"
